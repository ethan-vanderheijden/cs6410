...
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (myState := IN_COMMENT; commentDepth := 1; YYBEGIN COMMENT; continue()))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentDepth := !commentDepth + 1; continue()))
fun yyAction4 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("ended a comment that never started"); continue()))
...
fun yyAction8 (strm, lastMatch : yymatch) = (yystrm := strm;
      (myState := IN_STRING; stringStart := yypos; stringBuilder := ""; YYBEGIN STRING; continue()))
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;
      (myState := NORMAL; YYBEGIN INITIAL; Tokens.STRING(!stringBuilder, !stringStart, yypos + 1)))
fun yyAction10 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (stringBuilder := !stringBuilder ^ yytext; continue())
      end
fun yyAction11 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringBuilder := !stringBuilder ^ "\""; continue()))
...
fun yyAction18 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal escape code in string: " ^ yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction61(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction56(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction45(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ70(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ69(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction54(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction54(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction58(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction58(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction48(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction51(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction52(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction59(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction46(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction49(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction57(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction53(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction47(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ102(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction60(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ43 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ110(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ109(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
...
fun yyQ41 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction22(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ111(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
...
fun yyQ112 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ112(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"@"
              then yyQ17(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"@"
        ...
        | SOME(inp, strm') =>
            if inp = #"\r"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ10(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                  else yyQ10(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"!"
              then yyAction18(strm, yyNO_MATCH)
            else if inp < #"!"
              then if inp = #" "
                  then yyQ10(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                  else yyAction18(strm, yyNO_MATCH)
            else if inp = #"\\"
            ...
            if inp = #"0"
              ...
              then if inp = #"\r"
                  ...
                  then if inp = #"\n"
                      ...
                      then if inp = #"\t"
                          then yyQ9(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                          else yyQ8(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                    else if inp = #"\v"
                      then yyQ8(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
              ...
              then if inp = #"\\"
                  ...
                  then yyQ8(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                  else yyQ14(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
            else if inp = #"o"
              then yyQ8(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"n"
